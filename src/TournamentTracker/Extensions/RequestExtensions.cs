...
public static partial class RequestExtensions
{
    public static bool IsMobileRequest(this HttpContext httpContext)
        => httpContext.Request.IsMobileRequest();
    ...
    public static string Content(this IUrlHelper urlHelper, HttpContext httpContext, string contentPath)
        => Content(urlHelper, httpContext.Request, contentPath);

    private static string Content(IUrlHelper urlHelper, HttpRequest request, string contentPath)
    {
    ...
    private static partial Regex MobileBrowserRegex();
    ...
    private static partial Regex MobileBrowserVersionRegex();

    [GeneratedRegex(@"^/(?<culture>[a-z]{2})(/|$)", RegexOptions.IgnoreCase | RegexOptions.Compiled)]
    private static partial Regex RouteCultureRegex();
}